...
from codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.student.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_0703_0721_ablation_backbone_MISE import \
    Me as S
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        returnvalues, returnr, returnd, decode, w, rel, globali, scl = model2(inputs, depths, gts)
        ...
        loss_sal = feature_loss * 10e-8 + tradition_loss * 2 + attloss * 0.1
        # else:
