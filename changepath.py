...
if __name__ == '__main__':
    rootimage = '/home/wby/PycharmProjects/CoCA/data/gts/RGBD_CoSeg183'  # 原始图片文件父目录   # CADC CADC+D CBCS CoEGNet EGNet_vgg GCoNet GCoNet+D GICD GICD+D HSCS ICNet ICNet+D ICS MCLP
    disdir = '/home/wby/COA-EvaluationTools/Dataset/RGBD_CoSeg183'  # 移动到目标文件夹
