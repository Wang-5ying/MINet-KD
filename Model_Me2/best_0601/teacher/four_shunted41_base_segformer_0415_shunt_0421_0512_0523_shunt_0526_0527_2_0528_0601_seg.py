...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.sa3_2 = MultiSpectralAttentionLayer(320, 16, 16)
        ...
        self.td1 = torch.nn.ConvTranspose2d(512, 320, 3, 2, 1, 1, 1, True, 1)
        self.td2 = torch.nn.ConvTranspose2d(320, 128, 3, 2, 1, 1, 1, True, 1)
        ...
        self.cls = nn.Conv2d(320, 1, 1)
        self.adpgl1 = torch.nn.ConvTranspose2d(512, 320, 3, 2, 1, 1, 1, True, 1)
        self.adpgl2 = torch.nn.ConvTranspose2d(320, 128, 3, 2, 1, 1, 1, True, 1)
    ...
    def forward(self, x, y):
        ...
        # if self.training:
        #     return returnvalues, r, d, cls, decode, GATE_C, w, relation  # cls-->yuanlaishi 16
        # else:
        #     return returnvalues
...
if __name__ == '__main__':
    ...
    model = Me()
    model.cuda()
    model.load_pre("/media/wby/shuju/seg_pre/segformer.b4.640x640.ade.160k.pth")
    out = model(a, b)
    # end = time.time()
