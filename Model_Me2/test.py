...
# from codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.teacher.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_Small import Me as M
# from codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.teacher.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_backbone import Me as M
# from CoCA.codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.student.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_0703_0721 import \
#     Me as M
from CoCA.codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.teacher.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601 import \
    Me as M
    ...
    for testset in args.testsets.split('+'):
        ...
        for batch in tqdm(test_loader):
            ...
            with torch.no_grad():
                ...
                scaled_preds = out[-1]  # 取得模型的最后一个输出作为预测结果
        ...
        print(a.size(), a.size())
        flops, params = profile(model, (inputs, depths, gts))
        print(inputs.size(), depths.size())
        print("-------------------------")
        model.cuda()
        start = time.clock()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--testsets',
                        ...
                        # +CoSOD3k+Cosal2015 RGBD_CoSal150' RGBD_CoSal1k  RGBD_CoSal150 c DUTS_class RGBD_CoSeg183
                        type=str,
    ...
    parser.add_argument('--size',
                        ...
                        type=int,
                        help='input size')
    parser.add_argument('--ckpt', default='/media/wby/shuju/four/four_teacher_best/best_ep72_Smeasure0.8763.pth', type=str,  # 71-8627
                        help='model folder')
    parser.add_argument('--pred_dir',
                        default='/media/wby/shuju/ckpt/M/RGBD_CoSal1k',
