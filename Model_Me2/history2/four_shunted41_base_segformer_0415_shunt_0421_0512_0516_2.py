...
# from backbone.DIFFormer.nodeclassification.difformer import gcn_conv
class MLP(nn.Module):
    """
    Linear Embedding:
    """
...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.mlp2 = MixerBlock(128, 64, 128)
        self.mlp3 = MixerBlock(64, 32, 64)
        self.mlp1_1  = MixerBlock(256, 128, 256)  # 16 * 16
        self.mlp2_1 = MixerBlock(128, 64, 128)
        self.mlp3_1 = MixerBlock(64, 32, 64)
