...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.mlp_decode2 = DecoderHead([64, 128, 256, 512])
        self.mlp_decode3 = DecoderHead([64, 128, 256, 512])
    def forward(self, x, y):
        ...
        mlp_decode1 = F.interpolate(self.mlp_decode1(decoder), size=256)
        mlp_decode2 = F.interpolate(self.mlp_decode2(r[:4]), size=256)
        mlp_decode3 = F.interpolate(self.mlp_decode3(d[:4]), size=256)
        mlp_res = mlp_decode1 + mlp_decode2 + mlp_decode3
        # print(d3.size(),"d3")
        ...
        returnvalues.append(mlp_res)
        returnvalues.append(mlp_decode2)
        returnvalues.append(mlp_decode3)
