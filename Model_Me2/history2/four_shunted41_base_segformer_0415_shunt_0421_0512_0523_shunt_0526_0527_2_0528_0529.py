...
class Me(nn.Module):
    ...
    def forward(self, x, y):
        ...
        # ------- colomn2 ---------
        # z_stage2
        x = self.sa1(self.csa1(self.cca1(x + z)) + x)
        y = self.sa1(self.csa2(self.cca2(y + z)) + y)
        z = x + y + z
        ...
        # x = x_he * x + x
        # y = y_he * y + x
        x = self.sa2(self.soft1(self.gap1(x_he)) * x + x)
        y = self.sa2(self.soft2(self.gap2(y_he)) * y + y)
        # r_stage3
        B, C, H, W = x.size()
        ...
        # ------- colomn4 ---------
        # z_stage4
        x = self.sa3(self.csa3(self.cca3(x + z)) + x)
        y = self.sa3(self.csa4(self.cca4(y + z)) + y)
        z = x + y + z
        z = torch.cat((x, y, z), dim=0)
        b, c, h, w1 = z.size()
        # z = self.zen1(z)
        ...
        # x = x * x_he + x
        # y = y * y_he + x
        x = self.sa4(self.soft3(self.gap3(x_he)) * x + x)
        y = self.sa4(self.soft4(self.gap4(y_he)) * y + y)
        r.append(x)
        d.append(y)
        ...
        if self.training:
            return returnvalues, returnr, returnd, cls
        else:
            return returnvalues
