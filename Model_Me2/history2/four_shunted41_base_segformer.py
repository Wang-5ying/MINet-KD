...
from codes.GCoNet_plus_For_Four_Model.Model_Me.module import DD1, SpatialAttention, CM, BasicConv2d, SELayer
...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.DD1 = DD1(512, 320, [4, 2], [3, 2], [2, 4])
        self.DD2 = DD1(512, 128, [8, 4], [7, 3], [2, 2])
        self.DD3 = DD1(512, 64, [16, 8], [15, 7], [2, 2])
