...
class newASPP(nn.Module):
    def __init__(self, in_channels, atrous_rates, out_channels, h, w):
        super(newASPP, self).__init__()
        modules = []
        # 1*1 卷积
        ...
        for rate in rates:
            ...
            # modules.append(MultiSpectralAttentionLayer(in_channels, h, w))
...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        # self.zc1 = MultiSpectralAttentionLayer(12, 12, 256, 256)
        # self.zc2 = MultiSpectralAttentionLayer(3, 3, 256, 256)
        ...
        self.aspp1 = newASPP(256, [7, 5, 3, 1], 256, 16, 16)
        self.aspp2 = newASPP(128, [7, 5, 3, 1], 128, 32, 32)
        self.aspp3 = newASPP(64, [7, 5, 3, 1], 64, 64, 64)
    ...
    def forward(self, x, y):
        ...
        d = self.resnet2.forward_features(y)
        # z = self.resnet2.forward(z)
        # x = self.ca3(x_he) + x
        # r.append(x)
        # y = self.ca4(y_he) + y
        # d.append(y)
