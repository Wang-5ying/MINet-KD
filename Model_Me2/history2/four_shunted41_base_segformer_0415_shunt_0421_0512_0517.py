...
class PSDM(nn.Module):
    ...
    def __init__(self, input_dim1, input_dim2, input_dim3):
        ...
        self.proj4 = nn.Conv2d(input_dim1 + input_dim2 + input_dim3, 1, 3, 1, 1)
...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.dsm = PSDM(64, 128, 256)
        self.dsm2 = PSDM(64, 128, 256)
    def forward(self, x, y):
        ...
        dsm1 = self.dsm(r[0], r[1], r[2])
        dsm2 = self.dsm(d[0], d[1], d[2])
        # print("dsm", dsm.size())
        # print(d3.size(),"d3")
