...
from codes.GCoNet_plus_For_Four_Model.Model_Me.history_version.four_shunted41_base_segformer_0331 import Me as S
...
parser.add_argument('--epochs', default=320, type=int)  # 320
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        return_values, r, d, edge = model2(inputs, depths)  # , re, rei , edge
        ...
        loss_sal = loss1 + loss2 + loss3 + loss4 + loss5 # + edge_loss * 0.1 # + loss6 + loss7  #+ loss8 + loss9 + loss10
        # -----------------------------------------------------------------------------------------------------------------------------------------------
