...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.doc = nn.Conv2d(512, 512, 3, 1, 1)
        self.prs0 = nn.Conv2d(512, 256, 3, 1, 1)
        self.prs1 = nn.Conv2d(256, 128, 3, 1, 1)
        self.prs2 = nn.Conv2d(128, 64, 3, 1, 1)

        self.DD1 = DD(512, 256, [4, 2], [8, 8], [3, 2], [2, 4])
        self.DD2 = DD(512, 128, [8, 4], [16, 16], [7, 3], [2, 2])
        self.DD3 = DD(512, 64, [16, 8], [32, 32], [15, 7], [2, 2])

        self.res0 = BasicConv2d(256, 1, 3, 1, 1)
        self.res1 = BasicConv2d(128, 1, 3, 1, 1)
        self.res2 = BasicConv2d(64, 1, 3, 1, 1)
        self.res3 = BasicConv2d(128, 1, 3, 1, 1)
        self.end = BasicConv2d(128, 1, 3, 1, 1)

        self.supself1 = BasicConv2d(64, 1, 3, 1, 1)
