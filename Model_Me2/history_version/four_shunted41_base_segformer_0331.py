...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.DD1 = DD(512, 320, [4, 2], [3, 2], [2, 4])
        ...
        # -----------------0331------------------------
        self.edge1 = BasicConv2d(64, 1, 1)
        self.edge2 = BasicConv2d(64, 1, 1)
        # ---------------------------------------------
    ...
    def forward(self, x, y):
        ...
        # edge supervision
        edge = []
        edge.append(F.interpolate(self.edge1(r[0]), size=256))
        edge.append(F.interpolate(self.edge2(d[0]), size=256))
        # ----------------------------------------

        if self.training:
            return returnvalues, returnr, returnd, edge
        else:
            return returnvalues
