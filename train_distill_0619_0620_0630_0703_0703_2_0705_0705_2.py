...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        selfclp = sclloss(cls, clsy, clsn)/10000000
        featurecl = (sclloss_opiste(returnd[-1], returnr[-1]) + sclloss_opiste(returnd[-2], returnr[-2])) / 1000
        selfcl = selfclp + featurecl
        # print(selfcl, featurecl)
        # logit distillation
