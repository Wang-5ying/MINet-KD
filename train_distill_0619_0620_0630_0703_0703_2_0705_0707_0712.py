...
from codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.student.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_0703_0712 import \
    Me as S
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        # part 1 decoder
        kl5 = sclloss_op(decode[0] / temperature, Tdecode[0] / temperature)
        kl6 = sclloss_op(decode[1] / temperature, Tdecode[1] / temperature)
        kl7 = sclloss_op(decode[2] / temperature, Tdecode[2] / temperature)
        kl8 = sclloss_op(decode[3] / temperature, Tdecode[3] / temperature)
