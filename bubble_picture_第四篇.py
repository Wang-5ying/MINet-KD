...
data = pd.read_csv("model_2023_第四篇")
...
# plt.legend(handles=scatter.legend_elements(num=color)[0], labels=["GICD","CADC","GICD+D","GCoNet+D","ICNet+D","CADC+D","GCoNet","C$^{2}$D-S","C$^{2}$D-S*","C$^{2}$D-T"], loc=4)
plt.legend(handles=scatter.legend_elements(num=color)[0], labels=["GICD","CADC","GICD+D","GCoNet+D","ICNet+D","CADC+D","GCoNet","MINet-S","MINet-KD","MINet-T"], loc=4)
