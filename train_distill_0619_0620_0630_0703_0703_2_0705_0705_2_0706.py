...
from codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.student.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_0703_0706 import \
    Me as S
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        returnvalues, returnr, returnd, cls, decode, w, rel, r_gt, r_bak = model2(inputs, depths, gts)
        selfclp = sclloss(returnr[0], r_gt[0], r_bak[0]) + sclloss(returnr[1], r_gt[1], r_bak[1]) + sclloss(returnr[2], r_gt[2], r_bak[2]) + sclloss(returnr[3], r_gt[3], r_bak[3])
        selfcl = selfclp/10000000
        # print(selfcl)
        # logit distillation
        ...
        # print(fgd1, "fgd1")
        # if epoch < 100:
        loss_sal = feature_loss + tradition_loss + attloss * 0.1 + selfcl
        # else:
