...
import sys
sys.path.append('..')
from CoCA.codes.GCoNet_plus.config import Config
...
if __name__ == "__main__":
    ...
    parser.add_argument('--methods', type=str, default='M')
    parser.add_argument('--datasets', type=str, default='RGBD_CoSal1k')
    parser.add_argument('--gt_dir', type=str, default='/home/wby/PycharmProjects/CoCA/data/gts', help='GT')
    parser.add_argument('--pred_dir', type=str, default='/media/wby/shuju/ckpt/', help='predictions')
