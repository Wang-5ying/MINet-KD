...
from codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.student.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_0703_0721 import \
    Me as S
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        tradition_loss = (loss_sal1 + loss_sal2 + loss_sal3 + loss_sal4 + cls_loss) * 10
        ...
        # print(fgd1, "fgd1")
        # if epoch < 100:
        # print(feature_loss*10e-8, tradition_loss * 2, attloss, prot * 10e-7, scl * 10e-4)
        loss_sal = feature_loss * 10e-8 + tradition_loss * 2 + attloss + prot* 10e-7 + scl * 10e-4# + new
        # else:
