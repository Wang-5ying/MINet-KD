...
from backbone.Shunted_Transformer.SSA import shunted_s
...
class Me(nn.Module):
    ...
    def __init__(self, mode='small'):
        ...
        self.resnet = shunted_s()
        self.resnet2 = shunted_s()
        self.resnet3 = shunted_s()
        self.config = Config()
        ...
        self.adp1avg = nn.AdaptiveAvgPool2d(16)
        self.sig = nn.Sigmoid()
    def forward(self, x, y):
        ...
        # if self.training:
        #     return returnvalues, r, d, cls, decode, GATE_C, w, relation, rd  # cls-->yuanlaishi 16
        # else:
        #     return returnvalues
        if self.training:
...
if __name__ == '__main__':
    ...
    model = Me()
    model.cuda()
    model.load_pre("/media/wby/shuju/ckpt_S.pth")
    out = model(a, b)
    # end = time.time()
