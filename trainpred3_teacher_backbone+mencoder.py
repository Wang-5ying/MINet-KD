...
from codes.GCoNet_plus_For_Four_Model.Model_Me.best_0601.teacher.four_shunted41_base_segformer_0415_shunt_0421_0512_0523_shunt_0526_0527_2_0528_0601_backbone_mencoder import \
    Me as S
...
model2.load_pre("/media/wby/shuju/ckpt_B.pth")
...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        return_values, r, d = model2(inputs, depths)  # , re, rei , edge
