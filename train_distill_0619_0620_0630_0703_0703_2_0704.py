...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        selfcl_encoder = sclloss_opiste(returnr[-1], w[-1]) + sclloss_opiste(returnr[-1], returnd[-1])
        selfcl = sclloss(cls, clsy, clsn)/10000000 + selfcl_encoder/10000000
        # print(selfcl, selfcl_encoder)
        # logit distillation
