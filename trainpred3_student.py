...
def train(epoch, temperature):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        return_values, r, d, cls = model2(inputs, depths)  # , re, rei , edge
        ...
        # edge = CE(edge, edges)   # loss1 + loss2 + loss3 +
        # loss_sal = loss4 #+ loss5  #+ self_kd1 + self_kd2#  + loss6 # + loss_at# + loss_sdm1 * 6
        loss_sal = loss1 + loss2 + loss3 + loss4  #+ loss6 + loss7 + loss8# + edge_loss * 0.1 # + loss6 + loss7  #+ loss8 + loss9 + loss10
        # -----------------------------------------------------------------------------------------------------------------------------------------------
